...
import { withdraw } from "./communicator"

export default function WithdrawCard({wallet}: {wallet: Wallet}){
  ...
  return (
    ...
    <div className="flex justify-center">
        ...
        <form className="px-6 py-8 rounded-lg bg-black/50
                ...
                action={formAction}>
        <div className="font-bold flex justify-center cursor-pointer" onClick={() => setHidden(!hidden)}>Withdraw</div>
