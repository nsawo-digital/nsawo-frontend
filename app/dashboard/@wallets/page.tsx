...
export async function WalletCard({item}: {item: Wallet}){
    ...
    <div className="max-w-sm p-6 bg-gradient-to-br from-purple-600 to-emerald-500 border border-gray-200 rounded-lg shadow">
        ...
        <Link href={`/wallet/${item.id}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            More
